...
using Locations.Core.Application.Features.Products.Commands.DeleteProductById;
using Locations.Core.Application.Features.Products.Commands.UpdateProduct;
using Locations.Core.Application.Features.Products.Queries.GetAllProducts;
using Locations.Core.Application.Features.Products.Queries.GetProductById;
